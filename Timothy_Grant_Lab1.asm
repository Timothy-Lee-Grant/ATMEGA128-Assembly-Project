...
;***********************************************************
;*
;*	 Author: Modified byTimothy Grant (modification Oct 5, 2021)
;*	   Date: October 5, 2021
...
HitRight:
		...
		ldi		waitcnt, WTime	; Load another wait of 1 second
		rcall	Wait			; Call wait function again to double wait time (2 seconds)
