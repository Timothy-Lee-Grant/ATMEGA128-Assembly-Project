...
This code will cause the bumpbot to go forward until it hits something. It will then backup and turn around turn opposite to the side that it was it on. Then proceed forward again.
...
int main(void)
{
	...
	while (1) { // loop forever
		...
		if(PIND == 0b11111110)	//Right Hit
		{
			...
			_delay_ms(500);		//keep turning for for 500 ms
